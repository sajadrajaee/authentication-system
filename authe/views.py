...
#login_url page : redirects to the login page if no login was done
def home(request):   #-------- I THINK WE HAVE A LOGICAL ERROR HERE! # it is solved now()!
    user = request.user
    return render(request, 'authe/home.html', {'user':user})
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            try:
                ...
                mail_subject = f'{user.id}, users id'
